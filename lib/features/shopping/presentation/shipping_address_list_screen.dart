...
class ShippingAddressListScreen extends StatefulWidget {
  ShippingAddressListScreen({super.key});

  @override
  State<ShippingAddressListScreen> createState() => _ShippingAddressListScreenState();
}
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text("${address.phoneCode}${address?.mobileNo??""}",style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                                fontWeight: FontWeight.w400,
                              ),),
                            ],
                          ),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              GestureDetector(
                                  onTap: (){
                                    Get.context!.read<ShoppingCubit>().insertAddress(address);
